...
while [ ! -e /etc/letsencrypt/live/224wordpress	.duckdns.org ]; do
...
while [ ! -e /etc/letsencrypt/live/224openfire.duckdns.org ]; do
...
while [ ! -e /etc/letsencrypt/live/224openfire.duckdns.org-0001 ]; do
